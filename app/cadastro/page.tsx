          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Nome da sua ONG" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="email" placeholder="contato@ong.org" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <FormLabel>Imagem da ONG</FormLabel>
                    <FormControl>
                      <Input type="file" />
                    </FormControl>
                    <FormDescription>
                      Envie uma imagem que represente sua ONG (logotipo ou foto de atividades).
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
